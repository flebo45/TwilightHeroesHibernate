...
public class Player extends Personage {
    ...
    public void pgGenerator(Player player){
            ...
            player.setMoney(100);
            player.equippedArmor = new HashMap<>();
            ...
            switch (choice) {
                case 1 -> {
                    ...
                    player.classWeapon(playerClass, player);  
                ...
                case 3 -> {
                    ...
                    case 7 -> {
                        ...
                        player.setLuck(6);
                        String playerClass = "Guerriero" ;
                        player.classWeapon(playerClass, player);                        /*da definire come vengono assegnate le armi e le armature
                        player = new Model.Player(playerName, 80, 8, 5, 30);
                        player.addItem(new Model.Item("Bacchetta Magica", "Perfetta per lanciare incantesimi."));
                        player.addItem(new Model.Item("Libro degli Incantesimi", "Contiene formule magiche."));*/
                    }
    ...
    switch (type) {
        case "Guerriero":
            ...
            player.equipArmorPiece(helm, player);
            player.equipArmorPiece(chestplate, player);
            player.equipArmorPiece(gauntlet, player);
            player.equipArmorPiece(leggins, player);
    ...
    public void equipArmorPiece(Armor newArmor, Player player) {
        ...
        Armor currentArmor = equippedArmor.get(part);
        ...
        equippedArmor.put(part, newArmor);
